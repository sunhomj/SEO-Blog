...
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @babel/runtime-corejs2/helpers/esm/readOnlyError */ "./node_modules/@babel/runtime-corejs2/helpers/esm/readOnlyError.js");
...
var Category = function Category() {
  ...
  var categorieslistData = function categorieslistData() {
    Object(_actions_category__WEBPACK_IMPORTED_MODULE_12__["list"])(token).then(function (data) {
      if (data.error) {
  ...
  var categoryListTable = function categoryListTable(data) {
    var datalist = _objectSpread({}, data);

    datalist = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_6__["default"])("datalist"), datalist.map(function (el) {
      return __jsx("div", {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, {
    ...
    __self: this
  }, newCategoryForm(), categorieslistData());
};
...
//# sourceMappingURL=category-tag.js.0db193e8b6b09b5be190.hot-update.js.map