...
var BlogCreate = function BlogCreate(_ref) {
  ...
  var photoFileHandller = function photoFileHandller(name) {
    return function (e) {
      var _objectSpread2;
  ...
  var createBlogForm = function createBlogForm() {
    return __jsx("form", {
      ...
      onChange: categoryToggleHandller("title"),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 147
      },
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "Upload featured image", __jsx("small", {
    className: "text-muted",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 175
    ...
    __self: this
  }, " Max size:1 Mb"), __jsx("input", {
    onChange: photoFileHandller("photo"),
    type: "file",
    accept: "image/*",
    hidden: true,
    __source: {
...
//# sourceMappingURL=blog.js.39dbbe8c165191b6040e.hot-update.js.map